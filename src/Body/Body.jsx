...
import './Body.css';
import SliderA from '.././ImgSlider/SliderSite.png';
import SliderB from '.././ImgSlider/slider_sofa1.png';
import SliderC from '.././ImgSlider/sofa azul.png';
import SliderD from '.././ImgSlider/sofa-cinza.png';
            ...
            <body>
                ...
                <section className="SECB">
                    {/* SECB,SEB,SB = Section do Body */}
                        <ul className="ULB">
                            {/* ULB,UB = UL do Body */}
                            <li className="LIB">Carlos Antonio Barbosa</li> {/* LB,LIB = LI do Body */}
                            <li className="LC">Lorem reiciendis iste tempore deserunt rebo cumque? Praesentium, culpa?</li>
                            {/* LC = LI Comentário  */}
                        </ul>
                        <ul className="ULB">
                            {/* ULB,UB = UL do Body */}
                            <li className="LIB">João Silva Gomes</li> {/* LB,LIB = LI do Body */}
